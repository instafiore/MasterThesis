...
\begin{algorithm}[!t]\small
    ...
    \Begin{
        \If{$\ell \in \sigma$}{
            $g \gets \mathit{group}(\ell)$\;
            \If{$\mwh(g) = \wh(\ell)$} {
                \Return{$\bot$}
            }
            $\mathit{mps} \gets \mathit{mps} -\mwh(I,g) + \wh(\ell)$\;
        }
        \ElseIf{$\overline{\ell} \in \sigma$} {
            $g \gets \mathit{group}(\overline{\ell})$\;
            \If{$\wh(\overline{\ell}) = \mwh(I \setminus \{\ell\},g)$ and $\lits|_{\group(\ell)} \cap I = \emptyset$ }    {  
            $\mathit{mps} \gets \mathit{mps} + \mwh(I,g) - \wh(\ell)$\;        
            }
            \ElseIf{$|\lits|_{\group(\ell)} \setminus (I \cup \overline{I})| = 1$}
            {
                \Return{$\top$}
            }\Else{\Return{$\bot$}}    
        }
...
\begin{algorithm}[!t]\small
    ...
    \Begin{
        ...
        \For{$g \in \mathbb{G}$}{
            ...
            \If{$\lits|_g \cap I = \{\ell\}$}{
                $S \gets S \cup {(\overline{\ell_i},\{\overline{\ell_i},\overline{\ell})\}} \quad \forall \ell_i \in \lits|_{g} \setminus (\{\ell\} \cup I \cup \overline{I})$
            }

            \tcp{Enforced falsity rule}
            \For{$l \in \lits|_g$}{
                \If{$\ell \not\in I \cup \overline{I}$}{
                    \If{$mps - \mwh(I,g) + \wh(\ell) < lb$}{
                        $\mathit{rns}_\ell = \mathit{lits}_\sigma|_g \cup 
            ...
            \If{$\lits|_g \setminus (I \cup \mathit{falses}) = \{\ell\}$ and $\lits|_g \cap I = \emptyset$}{
                \If{$mps - \wh(\ell) < lb$}{
...
\begin{algorithm}[!t]\small
    ...
    \Begin{
        \If{$\ell \in \sigma$ or $\overline{\ell} \in \sigma $}{
            ...
            \If{$v = \top$}{
                \tcp{$\ell$ was true}
                \If{$\mwh(I,g) > weight[\ell]$}{
                    $mps \gets mps - weight[\ell] + weight[mw(G)]$\;
                }
            }
            \Else{
                \tcp{$\ell$ was false}            
                \If{$G$ has not true literal}{
                    $mps \gets mps - max\_w + weight[mw(G)]$\;
                }
            }
        }
    }
